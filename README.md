...
- [Synthetic Data Fidelity in Rare Strata](https://github.com/ShengPeiWilliam/mimic-synthetic-fidelity) — CART-based synthesis (synthpop) on MIMIC-IV (n=70,954 ICU stays), the same question against a different generator: count, not sample size, decides what's estimable. The generator attenuates it anyway.
